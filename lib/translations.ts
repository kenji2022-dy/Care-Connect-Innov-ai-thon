export const translations = {
  en: {
    ...
    heroSubtitle: "Get quick health guidance, symptom screening, medical triage, and connect with doctors seamlessly for personalized care",
    // Features
    ...
    reports: "Reports",
    analytics: "Analytics",
  noticeInterpreter: "Notice Interpreter",
    logout: "Logout",
    police: "Police",
    goals: "Goals",
  ...
  resources: "Resources",
    ...
    prescriptionOCRTitle: "Prescription OCR",
  transcribePrescription: "Transcribe Prescription",
  uploadImage: "Upload image",
  supportedImagesNote: "Supported: JPG, PNG, GIF. We will OCR and simplify in your selected language.",
  language: "Language",
  english: "English",
  hindi: "Hindi",
  telugu: "Telugu",
  ...
  speak: "Speak",
  stop: "Stop",
  extractedOCRText: "Extracted OCR Text",
  geminiResponse: "Gemini Response",
  langWarning: "Warning: Response may not be in the selected script.",
  ...
  hi: {
    ...
    // Hero Section
    heroTitle: "आपकी उंगलियों पर हेल्थकेयर",
    heroSubtitle: "त्वरित स्वास्थ्य मार्गदर्शन प्राप्त करें और डॉक्टरों से निर्बाध रूप से जुड़ें",
    ...
    prescriptionOCRTitle: "पर्चा OCR",
  uploadImage: "इमेज अपलोड करें",
  supportedImagesNote: "समर्थित: JPG, PNG, GIF. हम आपके चुने हुए भाषा में OCR और सरल व्याख्या करेंगे।",
  language: "भाषा",
  english: "English",
  hindi: "हिंदी",
  telugu: "तेलुगु",
  submit: "सबमिट करें",
  processing: "प्रक्रिया हो रहा है...",
  speak: "बोलें",
  stop: "रोकें",
  extractedOCRText: "निकाली गई OCR टेक्स्ट",
  geminiResponse: "Gemini प्रतिक्रिया",
  langWarning: "चेतावनी: प्रतिक्रिया चयनित लिपि में नहीं हो सकती है।",
    ...
    settings: "सेटिंग्स",
    patients: "मरीज़",  
    noticeInterpreter: "सूचना अनुवादक",
    reports: "रिपोर्ट्स",
  ...
  scenarioLab: "सीनारियो लैब",
    ...
    transcribePrescription: "पर्चा ट्रांसक्राइब करें",
