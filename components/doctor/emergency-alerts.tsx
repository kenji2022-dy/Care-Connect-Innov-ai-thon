  ...
  const [alerts, setAlerts] = useState<EmergencyAlert[]>([
    {
      ...
      location: {
        latitude: 17.4494,
        longitude: 78.6853,
        address: "Sreenidhi Institute of Science & Technology, Yamnampet, Ghatkesar, Hyderabad, Telangana 501301",
        accuracy: 15,
      },
      status: "active",
      priority: "critical",
      ...
      emergencyContacts: [
        { name: "Neha Sharma", phone: "+91-9876543210", relation: "Spouse", notified: true },
        { name: "Emergency Services", phone: "108", relation: "Emergency", notified: true },
      ],
    }
  ])
